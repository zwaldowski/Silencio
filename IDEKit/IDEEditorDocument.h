...
@class DVTDispatchLock, DVTExtension, DVTFileDataType, DVTFilePath, DVTMapTable, DVTNotificationToken, DVTStackBacktrace, DVTUndoManager;
...
- (void)restoreDocumentWindowWithIdentifier:(id)arg1 state:(id)arg2 completionHandler:(void(^)(void))arg3;
...
- (void)updateChangeCountWithToken:(id)arg1 forSaveOperation:(NSUInteger)arg2;
...
- (void)tryCloseAsynchronouslyWithCompletionBlock:(void(^)(void))arg1;
- (void)_tryCloseAsynchronouslyToRevert:(BOOL)arg1 withCompletionBlock:(void(^)(void))arg2;
- (void)_tryCloseAsynchronouslyToRevert:(BOOL)arg1 promptForUnsavedChanges:(BOOL)arg2 withCompletionBlock:(void(^)(void))arg3;
- (void)_canCloseAsynchronouslyToRevert:(BOOL)arg1 promptForUnsavedChanges:(BOOL)arg2 withCompletionBlock:(void(^)(void))arg3;
- (void)performActivityWithSynchronousWaiting:(BOOL)arg1 usingBlock:(void(^)(void))arg2;
...
- (id)fileURL;
- (void)relinquishPresentedItemToWriter:(void(^)(void))arg1;
- (void)_respondToFileChangeOnDiskWithFilePath:(id)arg1;
- (void)saveForOperation:(NSUInteger)arg1 withCompletionHandler:(void(^)(void))arg2;
- (void)saveToURL:(id)arg1 ofType:(id)arg2 forSaveOperation:(NSUInteger)arg3 completionHandler:(void(^)(void))arg4;
- (void)ide_finishSaving:(BOOL)arg1 forSaveOperation:(NSUInteger)arg2 previousPath:(id)arg3;
- (BOOL)writeSafelyToURL:(id)arg1 ofType:(id)arg2 forSaveOperation:(NSUInteger)arg3 error:(id *)arg4;
- (id)fileNameExtensionForType:(id)arg1 saveOperation:(NSUInteger)arg2;
...
- (id)newUndoManager;
- (void)_startUnlockIfNeededForWorkspace:(id)arg1 window:(id)arg2 completionBlock:(void(^)(void))arg3;
- (void)_unlockIfNeededCompletionBlock:(void(^)(void))arg1;
- (void)_changeWasRedone:(id)arg1;
- (void)_changeWasUndone:(id)arg1;
- (void)_changeWasDone:(id)arg1;
- (void)savePresentedItemChangesWithCompletionHandler:(void(^)(void))arg1;
- (void)autosaveWithImplicitCancellability:(BOOL)arg1 completionHandler:(void(^)(void))arg2;
- (void)continueAsynchronousWorkOnMainThreadUsingBlock:(void(^)(void))arg1;
- (void)continueActivityUsingBlock:(void(^)(void))arg1;
- (void)continueFileAccessUsingBlock:(void(^)(void))arg1;
...
- (void)convertToDocumentAtFilePath:(id)arg1 forFileDataType:(id)arg2 completionBlock:(void(^)(void))arg3;
